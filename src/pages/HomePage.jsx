            ...
            <section id='numberInfo'>
                <div className="MarginAuto1100px flex numberInfo">
                    <Link to="https://github.com/ErikPradoDev" target='_blank'>
                        <motion.div className='numberInfoSize'
                            initial={{ opacity: 0, x: -100 }}
            ...
            <section id='tech'>
                <div className="MarginAuto1100px flex">
                    <motion.h3
                        ...
                        transition={{ ease: "easeOut", duration: 1.5 }}
                        viewport={{ once: true }}
                    > {t('sectionTech.subtitle')} </motion.h3>
                    <motion.h2
                        initial={{ opacity: 0, x: -100 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ ease: "easeOut", duration: 1.5 }}
                        viewport={{ once: true }}
                    > {t('sectionTech.title')} </motion.h2>
                    ...
                    <div className='MarginAuto900px lineCard'>
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 4 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 5 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 6 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 7 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 8 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 9 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 10 }}
                            viewport={{ once: true }}
                        >
                            <svg width="19" height="19" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 11 }}
                            viewport={{ once: true }}
                        >
                            <svg width="19" height="19" viewBox="0 0 2500 2500" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_238_183)">
                                    ...
                                    <path d="M2500 1250V2500L1875 1875L2500 1250Z" fill="#5271B4" />
                                    <path d="M1250 1250L625 1875L0 2500V0L625 625L1250 1250Z" fill="#BB4B96" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_238_183">
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 12 }}
                            viewport={{ once: true }}
                        >
                        ...
                        <motion.div className='cardTec'
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ ease: "easeOut", duration: 1.5, delay: 0.2 * 13 }}
                            viewport={{ once: true }}
                        >
