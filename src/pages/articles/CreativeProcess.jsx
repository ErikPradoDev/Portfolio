...
export default function CreativeProcess(){
   ...
   <section id="welcome">
    ...
    <div className="MarginAuto1100px">
        ...
        <p className="txt"> {t('sectionBlog.blog1Resume')} </p>
        <p className="txt"> {t('sectionBlog.blog1Convite')} </p>
...
<section id="article" className="MarginAuto1100px">
    <div className="MarginAuto900px">
        <p className="txt"> {t('sectionBlog.p1')}  </p>
        <p className="txt"> {t('sectionBlog.p2')}  </p>
        <p className="txt"> {t('sectionBlog.p3')}  </p>
        <p className="txt"> {t('sectionBlog.p4')}   </p>

        <p className=" marginTop">  {t('sectionBlog.p5')}  </p>
    <ul>
