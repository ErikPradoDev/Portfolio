    ...
    return (
        <main>
            <section id='welcome' className='center'>
                <Decoration />
                <motion.div className='MarginAuto1100px containerWelcome'
            ...
            >
                <div className="MarginAuto1100px flex numberInfo">
                    ...
                    <Link to='/projects'>
                        <div className='numberInfoSize'>
                            <p className='number'><span className='hidden'>0</span>02</p>
                    ...
                    <a href='#tech'>
                        ...
                        >
                            <p className='number'><span className='hidden'>0</span>14</p>
                    ...
                    <Link to='/blog'>
                        <div className='numberInfoSize'
                            ...
                            transition={{ ease: "easeOut", duration: 1.5 }}
                        >
                            <p className='number'><span className='hidden'>0</span>01</p>
